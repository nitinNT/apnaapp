...
function PostCard({postId,title,desc,image,timestamp,user}) {
  ...
  return (
      <Card className="bg-dark text-white" onClick={(e) => viewPost(e)}>
      ...
      <Card.Footer>
        <small className="text-center" style={{float:"right"}} >posted by {user} at {timestamp}</small>
      </Card.Footer>
    </Card>
